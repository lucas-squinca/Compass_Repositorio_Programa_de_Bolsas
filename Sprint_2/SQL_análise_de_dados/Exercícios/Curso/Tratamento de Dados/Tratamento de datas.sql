...
select (current_date + interval '10 weeks')::date -- -> O "::date" serve para eliminar as horas da exibição, ficando somente a data;
...
select datediff('weeks','2018-06-01', current_date) -- Esta função não existe no pgadmin, somenteem outras linguagens de banco de dados;
